...
=========================================================================*/
#ifndef __itkQuadEdgeMeshGenerateDeformationFieldFilter_txx
#define __itkQuadEdgeMeshGenerateDeformationFieldFilter_txx
...
::GenerateData()
{
  ...
  while( destinationPointItr != destinationPointEnd )
    {
    displacementVectorItr.Value() = destinationPointItr.Value() - sourcePointItr.Value();
